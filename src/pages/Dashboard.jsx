  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-[#0a0a0f] pb-8 transition-colors duration-300">
      ...
      <div className="pt-14 pb-8 px-5 relative">
        ...
        <Link
          to="/settings"
          className="absolute top-3 right-5 w-8 h-8 flex items-center justify-center rounded-xl bg-white/60 dark:bg-white/5 border border-gray-200 dark:border-white/10 text-gray-500 dark:text-slate-400 hover:text-violet-500 dark:hover:text-violet-400 hover:bg-violet-50 dark:hover:bg-violet-500/10 transition-all"
          aria-label="Settings"
        >
